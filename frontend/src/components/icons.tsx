...
export const IcoPencil = () =>
  px([[5,1],[4,2],[3,3],[2,4],[1,5],[1,4]]);

export const IcoTrash = () =>
  px([[1,1],[2,1],[3,1],[4,1],[5,1],[1,2],[5,2],[2,3],[4,3],[2,4],[4,4],[1,5],[2,5],[3,5],[4,5],[5,5]]);

export const IcoArchive = () =>
  px([[1,1],[2,1],[3,1],[4,1],[5,1],[1,3],[5,3],[1,4],[3,4],[5,4],[1,5],[2,5],[3,5],[4,5],[5,5]]);

export const IcoBell = () =>
  px([[3,1],[2,2],[4,2],[2,3],[4,3],[1,4],[5,4],[1,5],[2,5],[3,5],[4,5],[5,5]]);
